 ...
 */
public class RewiewIdAllFromIQProvider extends IQProvider<ReviewIdAllFromResp>{

    @Override
    public ReviewIdAllFromResp parse(XmlPullParser parser, int initialDepth) throws XmlPullParserException, IOException, SmackException {

        ReviewIdAllFromResp reviewIdAllFromResp = new ReviewIdAllFromResp();
        ...
        reviewIdAllFromResp.setId_list(l_arr);

        return reviewIdAllFromResp;
    }
